...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" Runat="Server">
    ...
    <asp:ObjectDataSource ID="ArtistAlbumListODS" runat="server" OldValuesParameterFormatString="original_{0}" SelectMethod="Albums_ByArtist" TypeName="ChinookSystem.BLL.AlbumController">
        <SelectParameters>
